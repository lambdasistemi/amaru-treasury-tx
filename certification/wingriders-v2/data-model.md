...
| `DATA-VERDICT` | Exactly one allowed verdict, CQ1-CQ4 results, certification-failure boundary if any, separate top-level custody exposure and operator-acceptance requirement, live-agent open contract, registry deltas, enforcement `NONE`. |
