...
- [X] T329-SA3 `contingencyDisburseRequestJson` + `postBuild
      "/v1/build/contingency-disburse"`; render the
      `DisburseBuildResponse` success/failure surface as disburse does.
- [X] T329-SA4 `nix build .#frontend` green; browser smoke: add two
