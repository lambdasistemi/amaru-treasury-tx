...
- `docs/assets/intent-schema.json` (regenerated by `just update-schema`)
- `test/unit/Amaru/Treasury/IntentJSONSchemaSpec.hs` and
  `test/unit/Amaru/Treasury/IntentJSONSpec.hs` (extend existing)
