...
## Slice A — backend TTL lattice + response field
- [X] T357-SA implement `buildTxLattice` (cq-rdf body + prefix + entity overlay)
- [X] T357-SA add `ttl` field to the four build responses + JSON
