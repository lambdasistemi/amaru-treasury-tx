...
- [X] **T010** Replace `### VIII. IPFS-anchored disbursement evidence
...
- [X] **T020** Bump constitution version footer: `**Version**: 0.3.0`
      → `**Version**: 0.4.0`. Keep `Ratified: 2026-05-04` and
      `Last Amended: 2026-05-22`.
- [X] **T030** Create `vendors.yaml` at repository root with schema
...
- [X] **T070** Push to PR #211; rerun `./gate.sh` at HEAD; log
