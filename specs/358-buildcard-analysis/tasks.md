...
## Slice A — backend lattice input-values + 3 SPARQL proofs
- [X] T358-SA enrich lattice with resolved-input value triples
- [X] T358-SA 3 embedded .rq proofs + runner returning {name,columns,rows}
