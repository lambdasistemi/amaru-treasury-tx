...
- [X] T072 [US4] PR #162 body refreshed (slice 5 push + this commit): status table now lists all six slices with SHAs, the seven flat action tags, the operator chain, verification numbers (467 unit + 7 CBOR-equivalence goldens), and non-claims for #158-#161 / #163. Marked as `gh pr edit` action (not a commit); applied post slice 5 push.
