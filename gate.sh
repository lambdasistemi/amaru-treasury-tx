#!/usr/bin/env bash
# gate.sh — local pre-commit gate for the 179-swap-wizard-single-signer
# PR.  Lifecycle: dropped in the 'chore: drop gate.sh (ready for
# review)' commit just before the PR is marked ready.
set -euo pipefail
