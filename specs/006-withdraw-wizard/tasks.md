...
- [ ] T026 [P] [US2] Add zero-rewards resolver fixture in `test/fixtures/withdraw/zero-rewards/env.json`.
...
- [ ] T029 [US2] Implement typed zero-rewards result/event in `lib/Amaru/Treasury/Tx/WithdrawWizard.hs` and `lib/Amaru/Treasury/Tx/WithdrawWizard/Trace.hs`.
...
- [ ] T033 [P] [US3] Author synthetic frozen fixture files `test/fixtures/withdraw/synthetic/{intent,utxos,pparams,exunits}.json`.
...
- [ ] T041 [US3] Add fixture globs for `test/fixtures/withdraw/**/*.cbor` to `amaru-treasury-tx.cabal` once `expected.cbor` exists.
